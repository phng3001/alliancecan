...
if [ "$#" -ne 5 ]; then
    echo "Usage on terminal: bash $0 <container> <reference> <sample_name> <fasta_file_path> <minfrac>"
    echo "Usage on cluster: sbatch $0 <container> <reference> <sample_name> <fasta_file_path> <minfrac>"
    exit 1
fi
